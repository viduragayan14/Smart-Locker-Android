...
public class LoadFlowErrorActivity extends AppCompatActivity implements UdpServerThread.MessageReceived {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_loading_flow_error);
        bh = UdpServerThread.getInstance(LoadFlowErrorActivity.this, this);
        bh.setViewModelStoreOwner(LoadFlowErrorActivity.this,this);
        ...
        close.setOnClickListener(view -> {
            ...
            if (preference.getConnected() && preference.getConfig().equalsIgnoreCase(BackLoadingHelper.BACK_CONFIG)) {
                mainIntent = new Intent(LoadFlowErrorActivity.this, LoadingAreaActivity.class);

            } else {
                mainIntent = new Intent(LoadFlowErrorActivity.this, SelectCourierActivity.class);
            }
